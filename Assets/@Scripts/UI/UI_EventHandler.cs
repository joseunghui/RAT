...
{
    /**
     * Unity에서의 EventSystem Component가 감지한 정보를 받아와서 처리해주는 핸들러
     * IPointerClickHandler, IPointerDownHandler, IPointerUpHandler, IDragHandler 가 들어가있어야 터치, 드래그 등의 동작을 처리할 수 있음
     */
